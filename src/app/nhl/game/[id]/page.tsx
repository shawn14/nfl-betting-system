  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            <tr>
              <td className="py-3 text-gray-600">Goals Per Game</td>
              <td className="py-3 text-center font-mono text-lg text-gray-900">{formatNum(awayGPG)}</td>
              <td className="py-3 text-center font-mono text-lg text-gray-900">{formatNum(homeGPG)}</td>
            </tr>
            <tr>
              <td className="py-3 text-gray-600">Goals Allowed</td>
              <td className="py-3 text-center font-mono text-lg text-gray-900">{formatNum(awayGPGAllowed)}</td>
              <td className="py-3 text-center font-mono text-lg text-gray-900">{formatNum(homeGPGAllowed)}</td>
            </tr>
            <tr>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded p-4 border border-gray-200">
            <div className="text-gray-700 font-semibold text-lg mb-2">Step 1: Regress Stats to League Average (30%)</div>
            <div className="text-gray-600 mb-3">
              We regress each team's stats 30% toward league average ({LEAGUE_AVG_GPG} GPG) to account for small sample sizes.
            </div>
            <div className="grid grid-cols-2 gap-4 font-mono">
              <div className="space-y-1">
                <div className="text-gray-600">{away.abbreviation} GPG: {formatNum(awayGPG)} → <span className="text-gray-900 font-semibold">{formatNum(regAwayGPG)}</span></div>
                <div className="text-gray-600">{away.abbreviation} Allowed: {formatNum(awayGPGAllowed)} → <span className="text-gray-900 font-semibold">{formatNum(regAwayGPGAllowed)}</span></div>
              </div>
              <div className="space-y-1">
                <div className="text-gray-600">{home.abbreviation} GPG: {formatNum(homeGPG)} → <span className="text-gray-900 font-semibold">{formatNum(regHomeGPG)}</span></div>
                <div className="text-gray-600">{home.abbreviation} Allowed: {formatNum(homeGPGAllowed)} → <span className="text-gray-900 font-semibold">{formatNum(regHomeGPGAllowed)}</span></div>
              </div>
            </div>
          </div>
          ...
          {/* Step 2: Base Scores */}
          <div className="bg-gray-50 rounded p-4 border border-gray-200">
            <div className="text-gray-700 font-semibold text-lg mb-2">Step 2: Calculate Base Scores from Matchup</div>
            <div className="text-gray-600 mb-3">
              Each team's score = average of their offense vs opponent's defense.
            </div>
            <div className="font-mono space-y-2">
              <div className="text-gray-600">
                {home.abbreviation} Base = ({formatNum(regHomeGPG)} + {formatNum(regAwayGPGAllowed)}) / 2 = <span className="text-gray-900 text-xl font-semibold">{formatNum(baseHomeScore)}</span>
              </div>
              <div className="text-gray-600">
                {away.abbreviation} Base = ({formatNum(regAwayGPG)} + {formatNum(regHomeGPGAllowed)}) / 2 = <span className="text-gray-900 text-xl font-semibold">{formatNum(baseAwayScore)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded p-4 border border-gray-200">
            <div className="text-gray-700 font-semibold text-lg mb-2">Step 3: Elo Adjustment</div>
            <div className="text-gray-600 mb-3">
              Based on calibration: 100 Elo difference = {formatNum(ELO_TO_POINTS * 100)} goals. Split between teams.
            </div>
            <div className="font-mono space-y-2">
              <div className="text-gray-600">
          ...
          {/* Step 4: Home Ice */}
          <div className="bg-gray-50 rounded p-4 border border-gray-200">
            <div className="text-gray-700 font-semibold text-lg mb-2">Step 4: Home Ice Advantage</div>
            <div className="text-gray-600 mb-3">
              Based on calibration: home teams score {formatNum(HOME_ICE_ADVANTAGE)} more goals on average.
            </div>
            <div className="font-mono">
              <div className="text-gray-600">
                Split: <span className="text-gray-900 font-semibold">+{formatNum(HOME_ICE_ADVANTAGE / 2)}</span> to home, <span className="text-gray-900 font-semibold">-{formatNum(HOME_ICE_ADVANTAGE / 2)}</span> to away
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-100 border border-gray-300 rounded p-4">
            <div className="text-gray-700 font-semibold text-lg mb-3">Final Predicted Scores</div>
            <div className="font-mono space-y-2">
              <div className="text-gray-600 text-lg">
                {home.abbreviation} = {formatNum(baseHomeScore)} + {formatSpread(eloAdj)} + {formatNum(HOME_ICE_ADVANTAGE / 2)} = <span className="text-gray-900 text-2xl font-bold">{formatNum(finalHomeScore)}</span>
              </div>
              <div className="text-gray-600 text-lg">
                {away.abbreviation} = {formatNum(baseAwayScore)} - {formatNum(Math.abs(eloAdj))} - {formatNum(HOME_ICE_ADVANTAGE / 2)} = <span className="text-gray-900 text-2xl font-bold">{formatNum(finalAwayScore)}</span>
              </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-gray-50 rounded p-4 border border-gray-200">
            <div className="flex items-center justify-between mb-3">
              <div className="text-gray-500 uppercase font-semibold">Puck Line</div>
            ...
            <div className="space-y-3">
              ...
              {vegasSpread !== undefined && (
                <>
                  ...
                  <div className={`p-3 rounded ${Math.abs(spreadEdge) >= 1.5 ? 'bg-green-100 border border-green-300' : 'bg-gray-100 border border-gray-200'}`}>
                    <div className="text-gray-500 text-sm">Edge</div>
                    <div className="font-mono text-xl text-gray-900">{formatSpread(spreadEdge)} goals</div>
              ...
              {vegasTotal !== undefined && (
                <>
                  ...
                  {(() => {
                    ...
                    const isHighConf = ouEdge >= 0.5;
                    return (
                      <div className={`p-3 rounded ${isHighConf ? 'bg-green-100 border border-green-300' : 'bg-gray-100 border border-gray-200'}`}>
                        <div className="text-gray-500 text-sm">Edge</div>
                        <div className="font-mono text-xl text-gray-900">{formatSpread(totalEdge)} goals</div>
                        <div className="text-sm mt-2 font-medium text-gray-700">
                          {totalEdge > 0 ? `Pick OVER ${vegasTotal}` : `Pick UNDER ${vegasTotal}`}
                        </div>
                        {isHighConf && (
                          <div className="text-xs text-green-600 mt-1">High confidence at 0.5+ goal edge</div>
                        )}
                      </div>
                    );
                  })()}
      ...
      <div className="text-center py-4">
        <a href="/nhl" className="text-gray-600 hover:text-gray-800 text-lg">
          ← Back to NHL Picks
        </a>
      </div>
    </div>
