...
export default function WNBATeamClient() {
  const params = useParams();
  const rawAbbr = params.abbr as string;
  const abbr = rawAbbr.toUpperCase();
  const teamName = WNBA_TEAMS[abbr] || abbr;
  ...
  if (notFound) {
    return (
      <div className="text-center py-16">
        ...
        <Link href="/wnba/rankings" className="text-orange-500 hover:text-orange-600 font-medium">
          ← View all teams
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-sm text-gray-500">
        <Link href="/wnba/rankings" className="hover:text-orange-500">Rankings</Link>
