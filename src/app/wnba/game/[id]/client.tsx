...
// Constants from WNBA sync route
const LEAGUE_AVG_PPG = 84;
...
export default function WNBAGameDetailClient() {
  ...
  return (
    <div className="space-y-4 max-w-4xl mx-auto">
      ...
      <div className="text-center py-2">
        <a href="/wnba" className="text-blue-600 hover:text-blue-700">
          ← Back to WNBA Picks
        </a>
      </div>
    </div>
